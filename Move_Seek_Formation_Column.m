...
function [CurrentBoid, Boids] = Move_Seek_Formation_Column(Target, Weight, Boids, CurrentBoid, Leader, AfterLeader, BoidIndex)
global FleeDistance;
...
force = 0.5*steer_seek(CurrentBoid, Target);
