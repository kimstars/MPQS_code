...
[v_ImageD, v_AlphaD] = LoadImageBase('destroy.png', 150, 150, 0);
...
[NhasPlot] = InitializeBoid(v_ImageDef1, v_AlphaDef1, v_ImageD, v_AlphaD, 2, Nhas);
...
while (TimeStick5 < 6)
    ...
    while (dist(Boids(2, 1:3), b41(1, 1:3)) > 50)
        ...
        if (Boids(1, 15) > 0 )
            ...
            if (J > 0 && dist(Boids(1, 1:3), Nha(J,1:3)) < 300)
                ...
                if (sqrt(deviationXT * deviationXT + deviationYT * deviationYT) < 500)
                    AttackNha(1, J) = AttackNha(1, J) + 500;
                end
