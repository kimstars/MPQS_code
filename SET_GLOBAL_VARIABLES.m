...
global EnvironmentWidth ImageWidth SafeDistance AlignmentRange CohesionRange...
    ...
    MaxRedNum MaxBlueNum  Reds Red2s  Blues BloodPos SizeHPBar FlightsNum...
    AccuracyB AccuracyR;
...
%}
Reds(:,1) = 150*(rand([MaxRedNum,1])) -950; % set random position
Reds(:,2) = 150*(rand([MaxRedNum,1])) -950; % set random position
