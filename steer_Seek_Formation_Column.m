function [Boids, BoidsIndex]  = steer_Seek_Formation_Column(Target, Boids, Leader, D_Behind)
global BoidsNum;
...
[LeaderBehind, Boids] = Move_Seek_Formation_Column(Target, Weight, Boids, LeaderBehind,Leader, BehindLeader, MinIndex);
...
while (sum(BoidsFlag) < BoidsNum)    
    ...
    Weight = WeightsMatrix(MinIndex);
    [NearestRight, Boids] = Move_Seek_Formation_Column(Target, Weight, Boids, NearestRight,LeaderBehind,BehindLeader, MinIndex);
